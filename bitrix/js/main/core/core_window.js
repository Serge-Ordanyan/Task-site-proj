...
(function(window) {
    ...
    */
    ...
    BX.CDialog.prototype.showWait = function(el) {
        if (BX.type.isElementNode(el) && (el.type == 'button' || el.type == 'submit')) {
            ...
            el.bxwaiter = this.PARTS.FOOT.appendChild(BX.create('DIV', {
                props: {
                    className: 'adm-btn-load-img' + (bSave ? '-green' : '')
                },
                style: {
    ...
    BX.CDialog.prototype.Submit = function(params, url) {
        ...
        if (FORM) {
            ...
            BX.ajax.submit(FORM, BX.delegate(function() {
                this.closeWait()
            }, this));
        } else {
    ...
    */
    ...
    BX.CHintSimple.prototype.Init = function() {
        ...
        if (this.HINT)
            this.CONTENT_TEXT = this.CONTENT.appendChild(BX.create('DIV')).appendChild(BX.create('SPAN', {
                html: this.HINT
            }));
