...
import {
    ZIndexManager,
    ZIndexComponent
} from 'main.core.z-index-manager';
...
export default class Popup extends EventEmitter {
    ...
    constructor(options ? : PopupOptions) {
        ...
        this.emit('onInit', new BaseEvent({
         ...
         * @private
         */
        this.contentContainer = Tag.render `<div id="popup-window-content-${popupId}" class="popup-window-content"></div>`;

        /**
         * @private
         */
        this.popupContainer = Tag.render `<div 
        ...
        this.emit('onAfterInit', new BaseEvent({
            compatData: [popupId, this]
        }));
    }
    ...
    show(): void {
        ...
        if (!this.firstShow) {
            this.emit('onFirstShow', new BaseEvent({
                compatData: [this]
            }));
            this.firstShow = true;
        }

        this.emit('onShow', new BaseEvent({
            compatData: [this]
        }));
        ...
        this.animateOpening(() => {
            ...
            this.emit('onAfterShow', new BaseEvent({
                compatData: [this]
            }));
        });
    ...
    close(): void {
        ...
        this.emit('onClose', new BaseEvent({
            compatData: [this]
        }));
        ...
        this.animateClosing(() => {
            ...
            this.emit('onAfterClose', new BaseEvent({
                compatData: [this]
            }));
    ...
    destroy(): void {
        ...
        this.emit('onDestroy', new BaseEvent({
            compatData: [this]
        }));
    ...
    adjustPosition(bindOptions: {
        ...
        if (!this.bindOptions.forceBindPosition &&
            this.bindElementPos !== null &&
    ...
    handleDocumentMouseMove(event): void {
        ...
        if (!this.dragged) {
            this.emit(`on${this.dragOptions.eventName}Start`, new BaseEvent({
                compatData: [this]
            }));
            this.dragged = true;
        }

        this.emit(`on${this.dragOptions.eventName}`, new BaseEvent({
            compatData: [this]
        }));
    }
    ...
    handleDocumentMouseUp(event: MouseEvent): void {
        ...
        this.emit(`on${this.dragOptions.eventName}End`, new BaseEvent({
            compatData: [this]
        }));
        this.dragged = false;
